...
import os
import random
from augraphy import *  # Import all augmentations
...
input_image_path = "E:/ImgAgumentation/newImg.jpg"  # <-- Change if needed
...
# blend_image = cv2.imread("E:/ImgAgumentation/newImg.jpg", cv2.IMREAD_COLOR)
...
print("\n✅ All augmentations done! Check the 'new_Images_02' folder.")
